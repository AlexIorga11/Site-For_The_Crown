    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="PropunereNoua.aspx" title="Aceasta pagina va ajuta sa oferiti o preopunere legata de joc sau site sau sa raportati un bug">Propunere noua/Raportati bug</a></li>
        ...
        <div class="container">
            <div class="text-center mt-5">
                <h4 class="h4 mb-3 fw-normal">Propunere noua/Raportati un bug</h4>               
            </div>
             <div class="text-left mt-5" style="margin-left:3em">
                <p class="h5 mb-3 fw-normal">
                    <asp:DropDownList ID="DropDownList1" runat="server" Width="199px">
                        <asp:ListItem>Propunere</asp:ListItem>
      ...
      <asp:TextBox ID="TextBoxEmail" runat="server"  placeholder="E-mail" Width="300px" BackColor="#F0F0F0" BorderStyle="None" TextMode="Email"></asp:TextBox>
            ...
            <p class="h5 mb-3 fw-normal">
      <asp:TextBox ID="TextBoxTitlu" runat="server"  placeholder="Titlu" Width="547px" BackColor="#F0F0F0" BorderStyle="None"></asp:TextBox>
                </p>
            <p class="h5 mb-3 fw-normal">
      <asp:TextBox ID="TextBoxComm" runat="server"  placeholder="Comentariu" Width="547px" BackColor="#F0F0F0" BorderStyle="None" Height="112px" TextMode="MultiLine"></asp:TextBox>
                </p>
                <p class="h5 mb-3 fw-normal">
                    <asp:Button runat="server" class="w-100 btn btn-lg btn-primary" type="submit" ID="ButtonSubmit" OnClick="ButtonSubmit_Click" Text="Trimitere"></asp:Button>    
                    <asp:Label ID="Label1" runat="server"></asp:Label>
                </p>
            <p class="h5 mb-3 fw-normal">
                    <asp:Button runat="server" class="w-100 btn btn-lg btn-primary" type="submit" ID="ButtonCancel" OnClick="ButtonCancel_Click" Text="Anulare" Width="111px"></asp:Button>    
                    </p>
